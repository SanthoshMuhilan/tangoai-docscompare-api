...
from app.utils.cosmos_utils import save_file_metadata
...
async def uploadforcompare(file1: UploadFile = File(...), file2: UploadFile = File(...)):
    ...
    blob_url1 = await upload_to_blob(file1,folder="compare")
    blob_url2 = await upload_to_blob(file2,folder="compare")
    ...
    return { "file1": metadata1, "file2": metadata2, "message": "Files uploaded for comparison successfully." }
